...
<body class="bg-gray-50 min-h-screen">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600 mt-2">View feedback submissions and weekly reports</p>
        </div>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="w-10 h-10 bg-purple-100 rounded-lg flex items-center justify-center">
                        <svg class="w-5 h-5 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-2.863"></path>
                        </svg>
                    </div>
                </div>
            </div>
                        ...
                        <tr>
                            <td colspan="7" class="px-6 py-12 text-center">
                                <div class="text-gray-500">
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">No feedback submissions match your current filter.</p>
                                </div>
                            </td>
                        </tr>
                        @endforelse
